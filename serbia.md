...
- **The Administrative Court**, which reviews the legality of final administrative decisions, including EIA consents and permits — a real, if slow and inconsistent, route to have an unlawful decision annulled.
...
**Courts and inspectorates** want legality: which rule, which breach, which proof, which remedy. Keep it precise, sourced, and unemotional.
